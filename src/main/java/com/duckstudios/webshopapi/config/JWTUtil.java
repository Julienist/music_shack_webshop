package com.duckstudios.webshopapi.config;
...
//        int expirationHours = 6; je kan hiermee intern tijd-token expiration bepalen.
        Calendar appendableDate = Calendar.getInstance();
        appendableDate.setTime(new Date());
        appendableDate.add(Calendar.HOUR, expiration);
